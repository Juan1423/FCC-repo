  ...
  return (
    <>
        ...
        <Table size="small">
          ...
          <TableBody>
            {items.map(row => {
              ...
              return (
                <TableRow key={row.id_donacion_internacional}>
      ...
      <Dialog open={modalOpen} onClose={() => setModalOpen(false)} maxWidth="sm" fullWidth>
        <DialogTitle>Revisar Donación Internacional</DialogTitle>
          ...
          {selected && (
            <>
              ...
              {donantes[selected.id_donante_internacional] && (
                <Box sx={{ mb: 2 }}>
                  <Typography variant="body2"><strong>Nombre:</strong> {donantes[selected.id_donante_internacional].nombres} {donantes[selected.id_donante_internacional].apellidos}</Typography>
                  <Typography variant="body2"><strong>ID:</strong> {donantes[selected.id_donante_internacional].identificacion}</Typography>
                  <Typography variant="body2"><strong>Teléfono:</strong> {donantes[selected.id_donante_internacional].telefono}</Typography>
                  <Typography variant="body2"><strong>Email:</strong> {donantes[selected.id_donante_internacional].email}</Typography>
                </Box>
              )}
