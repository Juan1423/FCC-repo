...
export const getDocTipoProcesos = () => axios.get(`${base}/doc-tipo-proceso`).then((r) => r.data);
export const getDocTipoProceso = (id) => axios.get(`${base}/doc-tipo-proceso/${id}`).then((r) => r.data);
export const createDocTipoProceso = (data) => axios.post(`${base}/doc-tipo-proceso`, data).then((r) => r.data);
export const updateDocTipoProceso = (id, data) => axios.put(`${base}/doc-tipo-proceso/${id}`, data).then((r) => r.data);
export const deleteDocTipoProceso = (id) => axios.delete(`${base}/doc-tipo-proceso/${id}`).then((r) => r.data);
...
export const getDocTipoNormativas = () => axios.get(`${base}/doc-tipo-normativa`).then((r) => r.data);
export const getDocTipoNormativa = (id) => axios.get(`${base}/doc-tipo-normativa/${id}`).then((r) => r.data);
export const createDocTipoNormativa = (data) => axios.post(`${base}/doc-tipo-normativa`, data).then((r) => r.data);
export const updateDocTipoNormativa = (id, data) => axios.put(`${base}/doc-tipo-normativa/${id}`, data).then((r) => r.data);
export const deleteDocTipoNormativa = (id) => axios.delete(`${base}/doc-tipo-normativa/${id}`).then((r) => r.data);

/* ========== Normativa (documentación) ========== */
export const getDocNormativas = () => axios.get(`${base}/doc-normativa`).then((r) => r.data);
export const getDocNormativa = (id) => axios.get(`${base}/doc-normativa/${id}`).then((r) => r.data);
export const createDocNormativa = (data) => axios.post(`${base}/doc-normativa`, data).then((r) => r.data);
export const updateDocNormativa = (id, data) => axios.put(`${base}/doc-normativa/${id}`, data).then((r) => r.data);
export const deleteDocNormativa = (id) => axios.delete(`${base}/doc-normativa/${id}`).then((r) => r.data);

/* ========== Tipo Institucion ========== */
export const getTipoInstituciones = () => axios.get(`${base}/tipo-institucion`).then((r) => r.data);
export const getTipoInstitucion = (id) => axios.get(`${base}/tipo-institucion/${id}`).then((r) => r.data);
export const createTipoInstitucion = (data) => axios.post(`${base}/tipo-institucion`, data).then((r) => r.data);
export const updateTipoInstitucion = (id, data) => axios.put(`${base}/tipo-institucion/${id}`, data).then((r) => r.data);
export const deleteTipoInstitucion = (id) => axios.delete(`${base}/tipo-institucion/${id}`).then((r) => r.data);
...
/* ========== Tipo Documento ========== */
export const getTipoDocumentos = () => axios.get(`${base}/tipo-documento`).then((r) => r.data);
export const getTipoDocumento = (id) => axios.get(`${base}/tipo-documento/${id}`).then((r) => r.data);
export const createTipoDocumento = (data) => axios.post(`${base}/tipo-documento`, data).then((r) => r.data);
export const updateTipoDocumento = (id, data) => axios.put(`${base}/tipo-documento/${id}`, data).then((r) => r.data);
export const deleteTipoDocumento = (id) => axios.delete(`${base}/tipo-documento/${id}`).then((r) => r.data);
...
export const getRegistrarProceso = (id) => axios.get(`${base}/registrar-procesos/${id}`).then((r) => r.data);
export const createRegistrarProceso = (data) => axios.post(`${base}/registrar-procesos`, data).then((r) => r.data);
export const updateRegistrarProceso = (id, data) => axios.put(`${base}/registrar-procesos/${id}`, data).then((r) => r.data);
export const deleteRegistrarProceso = (id) => axios.delete(`${base}/registrar-procesos/${id}`).then((r) => r.data);